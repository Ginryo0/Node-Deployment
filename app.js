...
const MONGODB_URI = `mongodb+srv://${process.env.MONGO_USER}:${process.env.MONGO_PASSWORD}@cluster0.spv0bgt.mongodb.net/${process.env.MONGO_DEFAULT_DB}?`;
...
mongoose
  ...
  .then((result) => {
    // https
    //   .createServer({ key: privateKey, cert: cerificate }, app)
